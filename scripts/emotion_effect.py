"""
Multitask Fine-Tuning with Emotion Labels

This script performs multitask fine-tuning on a pre-trained model (FacebookAI/roberta-base) 
using combined datasets (spam review, fake news, AI-generated detection). Each data point includes emotions, to assess whether incorporating emotional context improves model generalization and task specific 
performance.
...
#%%
df = pd.read_csv("../data/merged_datas_no_emotion.csv") #Observing how emotion impacts
df.head()
df.shape
